...
def win(player_number):
    while True:
        ...
        draw_text(f'O JOGADOR {player_number} VENCEU!', FONTS["NORMAL"]["pygameFont"], (255, 255, 255), window, 50, 100)
        window.blit(IMAGENS[f"BONECO{player_number}BIG"]["pygameImage"], (200, 300))
